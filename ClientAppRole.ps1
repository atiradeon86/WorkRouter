...
$SqlServer = "BRYAN-Work\BRYAN"
    ...
    EXEC app.GetWorksByWorksheetNumber @Worksheetnumber ='WS-AT000056'
    EXEC app.GetWorksByWorksheetNumberDE @Worksheetnumber ='WS-AT000056'
    EXEC app.GetWorksByWorksheetNumberEN @Worksheetnumber ='WS-AT000056'
    "
